...
That procedure passed on 2026-09-26. Seed 58 created the Ghostlight Nursery chunk with 625 vertices, 1,152 triangles, a ready collider, an estimated 33.0 KiB mesh, and a +32.0 KiB managed-memory delta. Terrain relief and collision passed, removal returned the status to inactive, and a save/full restart remained inactive while preserving schema 3, seed 58, three regions, 123 placements, and a passing performance budget. The -700 metre staging depth required a flashlight, so subsequent diagnostic terrain slices include temporary inspection lighting; production lighting remains biome-driven.
