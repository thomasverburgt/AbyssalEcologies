...
- Ground landmarks with bounded local raycasts only after their cells naturally stream. *(0.8.1 proved delayed terrain availability beneath AE1/AE3 and open water at AE2's exact center; 0.8.2 adds delayed retries and a deterministic 72-metre nearby-surface search, with remote batch loading still disabled and field validation pending)*
