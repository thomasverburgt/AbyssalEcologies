...
- Ground landmarks with bounded local raycasts only after their cells naturally stream. *(0.8.2 proved single-point grounding was inadequate by accepting visibly unsuitable 38.6/32.5-degree slopes and still failing AE2; 0.8.3 adds nine-point level-footprint validation plus a 144-metre higher-origin search, with remote batch loading still disabled and field validation pending)*
