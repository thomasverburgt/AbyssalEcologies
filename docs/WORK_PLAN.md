...
| Partial; AE2 retest pending | Local landmark grounding | Anchor broad central landmarks on level support only after their cells naturally stream | 0.8.4 level foundations passed AE1/AE3 with 9/9 terrain hits; after 0.8.5's one-direction flora offset failed, 0.8.6 searches bounded eight-point rings around the eight nearest flora before the radial fallback |
